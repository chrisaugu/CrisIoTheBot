...
function serverInfo2Table(serverInfoArray) {
    ...
    for (var i in serverInfoArray) {
        ...
        table += "<tr>";
        table += "<td class=\"TableHeader\">Your DNS Server</td>" + "<td class=\"TableData\">" + serverInfoArray[i].ipAddress.ipAddress + "</td>";
        table += "</tr>";
        table += "<tr>";
        table += "<td class=\"TableHeader\">Owner of this server</td>" + "<td class=\"TableData\">" + serverInfoArray[i].ipAddress.isp + "</td>";
        table += "</tr>";
        table += "<tr>";
        table += "<td class=\"TableHeader\">Status of this server</td>" + "<td class=\"TableData\">" + issueStatus + "</td>";
        table += "</tr>";
        table += "</table></td></tr>";
    }
